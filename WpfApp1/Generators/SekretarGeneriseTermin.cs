...
{
    class SekretarGeneriseTermin: IReportGenerator<TimeInterval>
    {
        public App app;
        private string _path;

        public SekretarGeneriseTermin(string path)
        {
            app = Application.Current as App;
            _path = path;
        }

        public List<Appointment> GetAvailableMedicalAppointments(TimeInterval timeInterval)
        {
